...
It means that there is something wrong with the data. We must tidy the data by removing the rows or changing the format of some of the numerical answers.
